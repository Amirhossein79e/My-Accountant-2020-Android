...
import com.amirhosseinemadi.myAccountant.view.ShowSpendActivity;

public class ViewModelSelect {

    private AppCompatActivity activity;

    public ViewModelSelect(AppCompatActivity activity)
    {
    ...
    {
        Intent intent = new Intent(Application.component.context(), ShowSpendActivity.class);
